...
```bash
nextflow run main.nf -profile apptainer_wsl_gpu --input scripts/samples_extended.tsv --output_dir example_results/ --gtdb_protein_reps /data/dbs/gtdb/release226/protein_faa_reps --gtdb_db_dir novotax_db_r226
```
